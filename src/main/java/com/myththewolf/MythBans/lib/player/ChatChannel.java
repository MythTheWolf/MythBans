...
import com.myththewolf.MythBans.lib.feilds.ConfigProperties;
 ...
 public class ChatChannel
 {
   ...
   public HashMap<String, String> getMap() { return this.chanMap; }
   ...
   public void push(Player send, String message) throws SQLException {
     ...
     if (send.hasPermission("essentials.chat.color")) {
       template = ChatColor.WHITE + "<" + who + ChatColor.WHITE + "> " + ChatColor.translateAlternateColorCodes('&', message);
     } else {
   ...
   public boolean exists() { return this.EXIST; }
   ...
   public void setShortcut(String shor) { this.SHORTCUT = shor; }
